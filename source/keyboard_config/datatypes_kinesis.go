...
var _ = KeycodeLayerHalf{
	...
	KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_RIGHT_SHIFT,
	KC_GRAVE, KC_INSERT, KC_LEFT, KC_RIGHT, KC_UP, KC_DOWN, KC_LEFT_BRACKET, KC_RIGHT_BRACKET,
	KC_LEFT_CTRL,
	KC_BACKSPACE, KC_DELETE, KC_END, KC_HOME, KC_LEFT_ALT,

	KC_RIGHT_CTRL,
	KC_RIGHT_GUI, KC_PAGE_UP, KC_PAGE_DOWN, KC_ENTER, KC_SPACE,

	KC_VK_LPEDAL, KC_VK_MPEDAL, KC_VK_RPEDAL,
}
