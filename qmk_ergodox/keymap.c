...
KC_M, KC_SEMICOLON, KC_QUOTE, KC_COMMA, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN4, 
KC_MS_BTN3, KC_MS_BTN2, KC_MS_BTN1, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, 
KC_TRANSPARENT, MO(1), KC_LEFT_GUI, KC_DELETE, MO(1), KC_LEFT_CTRL, KC_TAB, 
...
KC_TRANSPARENT, ST_MACRO_Anglebrakets, ST_MACRO_Parenthesis, ST_MACRO_SquareBraces, ST_MACRO_CurlyBraces, LSFT(KC_3), LSFT(KC_8), 
...
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_0, KC_0, KC_TRANSPARENT, KC_TRANSPARENT, 
