...
KC_TRANSPARENT, KC_U, KC_O, KC_Y, KC_SEMICOLON, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_N, KC_S, KC_T, KC_R, KC_COMMA, KC_A, 
KC_E, KC_I, KC_C, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_P, 
KC_F, KC_M, KC_H, KC_QUOTE, KC_TRANSPARENT, LSFT(KC_QUOTE), KC_K, 
KC_J, KC_X, KC_G, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_Z, 
