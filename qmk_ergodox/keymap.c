...
KC_M, KC_P, KC_Q, KC_COMMA, TO(2), KC_TRANSPARENT, KC_LEFT, 
KC_DOWN, KC_UP, KC_RIGHT, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, 
...
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_X, KC_D, KC_H, KC_K, KC_QUOTE, KC_TRANSPARENT, 
KC_TRANSPARENT, LSFT(KC_QUOTE), KC_U, KC_F, KC_L, KC_J, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_N, KC_S, KC_R, KC_T, KC_DOT, KC_COMMA, 
KC_A, KC_E, KC_O, KC_I, KC_TRANSPARENT, KC_TRANSPARENT, KC_B, 
KC_W, KC_C, KC_V, KC_Z, KC_TRANSPARENT, KC_TRANSPARENT, KC_Q, 
KC_M, KC_G, KC_P, KC_Y, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ), //[2] = GENERATED
