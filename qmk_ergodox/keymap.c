...
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_COMMA, KC_W, KC_D, KC_L, KC_V, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_B, KC_U, KC_O, KC_Y, KC_SEMICOLON, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_COMMA, KC_S, KC_T, KC_R, KC_N, KC_C, 
KC_A, KC_E, KC_I, KC_DOT, KC_TRANSPARENT, KC_TRANSPARENT, KC_Q, 
KC_F, KC_M, KC_H, KC_P, KC_TRANSPARENT, KC_TRANSPARENT, KC_G, 
KC_K, KC_J, KC_X, KC_Z, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(1), KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ), //[2] = GENERATED
