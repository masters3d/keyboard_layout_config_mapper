...
ST_MACRO_Screenshot, LSFT(KC_0), KC_RIGHT_BRACKET, KC_MINUS, KC_QUOTE, KC_SLASH, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_BACKSLASH, LSFT(KC_QUOTE), KC_EQUAL, KC_LEFT_BRACKET, LSFT(KC_9), KC_TRANSPARENT, 
...
KC_M, KC_P, KC_Q, KC_COMMA, TO(2), KC_TRANSPARENT, KC_MS_BTN4, 
...
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_D, KC_H, KC_K, KC_DOT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_COMMA, KC_U, KC_F, KC_L, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_N, KC_S, KC_R, KC_T, KC_DOT, KC_COMMA, 
KC_A, KC_E, KC_O, KC_I, KC_TRANSPARENT, KC_TRANSPARENT, KC_B, 
KC_W, KC_C, KC_V, KC_DOT, KC_TRANSPARENT, KC_TRANSPARENT, KC_COMMA, 
KC_M, KC_G, KC_P, KC_Y, KC_TRANSPARENT, KC_TRANSPARENT, KC_Z, 
KC_X, KC_J, KC_Q, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ), //[2] = GENERATED
