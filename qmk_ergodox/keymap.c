...
KC_TRANSPARENT, LSFT(KC_QUOTE), KC_U, KC_C, KC_Y, KC_B, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_N, KC_S, KC_T, KC_R, KC_DOT, KC_COMMA, 
KC_A, KC_E, KC_I, KC_O, KC_TRANSPARENT, KC_TRANSPARENT, KC_P, 
KC_F, KC_M, KC_H, KC_Z, KC_TRANSPARENT, KC_TRANSPARENT, KC_Q, 
KC_K, KC_J, KC_G, KC_X, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ), //[2] = GENERATED
